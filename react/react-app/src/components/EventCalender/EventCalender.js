...
function EventCalender() {
    ...
    const [newEvent, setNewEvent] = useState(
        { title: '', date: selectedDate, time: '', description: '', mode: ''}
    );
    ...
    return (
        <div className='Eventcontener'>
            ...
            <Link to="/student"><FontAwesomeIcon icon={faArrowLeft} className='Eventicon' /></Link>
                <h1>Calendar</h1>
                <FontAwesomeIcon icon={faPlus} className='Eventicon' onClick={handleAddEvent} />
            </div>
